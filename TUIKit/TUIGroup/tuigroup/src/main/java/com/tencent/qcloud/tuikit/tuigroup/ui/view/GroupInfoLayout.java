...
public class GroupInfoLayout extends LinearLayout implements IGroupMemberLayout, View.OnClickListener {
    ...
    private void init() {
        ...
        mTitleBar.setOnLeftClickListener(view -> ((Activity) getContext()).finish());
        ...
        mTopSwitchView.setCheckListener((buttonView, isChecked) -> {
            if (mGroupInfo == null) {
                return;
            }
    ...
    private void initView() {
        ...
        GlideEngine.loadUserIcon(mGroupIcon, mGroupInfo.getFaceUrl(), TUIThemeManager.getAttrResId(getContext(), com.tencent.qcloud.tuicore.R.attr.core_default_group_icon), radius);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.group_member_bar) {
            ...
            GroupNoticeActivity.setOnGroupNoticeChangedListener(notice -> {
            ...
            SelectionActivity.startListSelection((Activity) getContext(), bundle, text -> mPresenter.modifyGroupInfo((Integer) text, TUIGroupConstants.Group.MODIFY_GROUP_JOIN_TYPE));
            ...
            if (mGroupInfo.isOwner() &&
                ...
                new TUIKitDialog(getContext())
                        ...
                        .setPositiveButton(getContext().getString(com.tencent.qcloud.tuicore.R.string.sure), v14 -> mPresenter.deleteGroup(new IUIKitCallback<Void>() {
                            @Override
                            public void onSuccess(Void data) {
                        ...
                        .setNegativeButton(getContext().getString(com.tencent.qcloud.tuicore.R.string.cancel), v15 -> {
                ...
                new TUIKitDialog(getContext())
                        ...
                        .setDialogWidth(0.75f)
                        .setPositiveButton(getContext().getString(com.tencent.qcloud.tuicore.R.string.sure), v1 -> mPresenter.quitGroup(new IUIKitCallback<Void>() {
                            @Override
                            public void onSuccess(Void data) {
                                ((Activity) GroupInfoLayout.this.getContext()).finish();
                            }
            ...
            new TUIKitDialog(getContext())
                    ...
                    .setDialogWidth(0.75f)
                    .setPositiveButton(getContext().getString(com.tencent.qcloud.tuicore.R.string.sure), v13 -> {
    ...
    public void setGroupInfo(GroupInfo info) {
        ...
        if (GroupInfo.GROUP_TYPE_MEETING.equals(info.getGroupType())) {
            ...
            mMsgRevOptionSwitchView.setCheckListener((buttonView, isChecked) -> mPresenter.setGroupReceiveMessageOpt(mGroupInfo, isChecked));
        }
