...
public class FriendProfileLayout extends LinearLayout implements View.OnClickListener, IFriendProfileLayout {
    ...
    private void initEvent() {
        ...
        refuseFriendBtn.setOnClickListener(v -> refuse());

        acceptFriendBtn.setOnClickListener(v -> accept());
    }
    ...
    private void setViewContentFromContactGroupApplyInfo(ContactGroupApplyInfo data) {
        ...
        deleteFriendBtn.setOnClickListener(v -> refuseJoinGroupApply(info));
        chatBtn.setText(R.string.accept);
        chatBtn.setOnClickListener(v -> acceptJoinGroupApply(info));
    }
    ...
    private void setViewContentFromGroupInfo(GroupInfo groupInfo) {
        ...
        GlideEngine.loadUserIcon(mHeadImageView, groupInfo.getFaceUrl(), com.tencent.qcloud.tuicore.R.drawable.core_default_group_icon_serious, radius);
    ...
    private void updateMessageOptionView() {
        ...
        //set
        mMessageOptionView.setCheckListener((buttonView, isChecked) -> presenter.setC2CReceiveMessageOpt(userIdList, isChecked));
    }
