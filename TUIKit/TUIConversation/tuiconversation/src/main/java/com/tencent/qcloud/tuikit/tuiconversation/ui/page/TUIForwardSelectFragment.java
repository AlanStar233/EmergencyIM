...
public class TUIForwardSelectFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mForwardLayout.getConversationList().setOnItemClickListener((view1, viewType, conversationInfo) -> {
    ...
    private void forwardMessages(final ConversationInfo conversationInfo){
        ...
        //设置正面按钮
        builder.setPositiveButton(getString(com.tencent.qcloud.tuicore.R.string.sure), (dialog, which) -> {
            if (getActivity() != null) {
        ...
        //设置反面按钮
        builder.setNegativeButton(getString(com.tencent.qcloud.tuicore.R.string.cancel), (dialog, which) -> dialog.dismiss());
    ...
    private void initTitleAction() {
        mForwardLayout.getTitleBar().setOnLeftClickListener(view -> {
            //点击取消/关闭
            if(mTitleBarLayout.getLeftTitle().getText().equals(getString(R.string.titlebar_cancle))){
                mTitleBarLayout.getRightGroup().setVisibility(View.VISIBLE);
        ...
        mForwardLayout.getTitleBar().setOnRightClickListener(view -> {
            //点击多选
