package com.alanstar.imtencentui.push;
...
import com.alanstar.imtencentui.MyApplication;
import com.alanstar.imtencentui.R;
import com.alanstar.imtencentui.utils.BrandUtil;
...
public class OfflineMessageDispatcher {
    ...
    private static OfflineMessageBean offlineMessageBeanValidCheck(OfflineMessageBean bean) {
        if (bean == null) {
            ...
            String label = String.valueOf(packageManager.getApplicationLabel(MyApplication.instance().getApplicationInfo()));
            ToastUtil.toastLongMessage(MyApplication.instance().getString(R.string.you_app) + label + MyApplication.instance().getString(R.string.low_version));
