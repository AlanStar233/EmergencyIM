package com.alanstar.imtencentui.login;
...
public class ThemeSelectActivity extends BaseLightActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleBarLayout.getLeftGroup().setOnClickListener(v -> onBackPressed());
    ...
    private void changeTitleBackground() {
        int color = getResources().getColor(com.tencent.qcloud.tuicore.R.color.core_header_end_color_light);
        int titleColor = getResources().getColor(com.tencent.qcloud.tuicore.R.color.core_title_bar_text_bg_light);
        int backIconId = com.tencent.qcloud.tuicore.R.color.core_title_bar_text_bg_light;
        if (currentThemeId == TUIThemeManager.THEME_LIVELY) {
            ...
            backIconId = com.tencent.qcloud.tuicore.R.color.core_title_bar_text_bg_lively;
            ...
            backIconId = com.tencent.qcloud.tuicore.R.color.core_title_bar_text_bg_serious;
        }
    ...
    class SelectAdapter extends RecyclerView.Adapter<SelectAdapter.SelectViewHolder> {
        ...
        public void onBindViewHolder(@NonNull SelectAdapter.SelectViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> onItemClickListener.onClick(themeBean.id));
        }
