package com.alanstar.imtencentui.bean;
...
public class UserInfo implements Serializable {
    ...
    public synchronized static UserInfo getInstance() {
        if (sUserInfo == null) {
            SharedPreferences shareInfo = MyApplication.instance().getSharedPreferences(TUIKitConstants.USERINFO, 0);
    ...
    public void setSdkAppId(int sdkAppId) { this.sdkAppId = sdkAppId; }
