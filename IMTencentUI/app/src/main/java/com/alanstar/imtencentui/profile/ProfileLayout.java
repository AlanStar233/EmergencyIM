...
import com.alanstar.imtencentui.utils.Constants;
...
public class ProfileLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        messageReadStatusSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
        ...
        userStatusSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.modify_allow_type) {
            ...
            SelectionActivity.startListSelection((Activity) getContext(), bundle, text -> {
